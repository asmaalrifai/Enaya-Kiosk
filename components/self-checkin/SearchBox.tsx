...
export default function SearchBox({ value, onChange, label = "Enter your name or phone number", placeholder }: Props) {
  return (
    <div>
      ...
      <div className="relative">
        <input
          ...
          placeholder={placeholder || "e.g., Aisha Al Mansour or 05xxxxxxxx"}
